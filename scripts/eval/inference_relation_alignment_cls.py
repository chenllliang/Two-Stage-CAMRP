...
inference_dataset, node_num_list =  load_inference_dataset(NODES_DIR)
...
OUT_DIR="./models/0817/3e-5_batch50_ralign_class_both_rel_and_func_words"
...
with open(NODES_DIR+".ralign","w") as f:
    for i in result:
