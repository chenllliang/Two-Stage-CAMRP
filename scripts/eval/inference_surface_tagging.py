...
inference_dataset = load_inference_dataset(input_dir)
...
model = AutoModelForTokenClassification.from_pretrained(model_dir, num_labels=8)
...
with open(out_dir+".surface","w") as f:
