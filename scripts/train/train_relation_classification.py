...
dataset = build_train_dev_dataset_4level("../../preprocessed/relation_classification/train","../../preprocessed/relation_classification/dev")
...
OUT_DIR="../../models/relation_classication"
